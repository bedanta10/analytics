...
?women
plot(women)
plot(women, type='p', pch=17) #changing the plotting symbol
plot(women, type='l')
plot(women, type='b', pch=18, lty=2, col='blue', lwd=5)
...
#barplot
barplot(x,col=1:4) #difference between barplot and histogram
